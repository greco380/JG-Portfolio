...
const HolographicGlobe: React.FC = () => {
  ...
  const landPolygons = [
    // Africa (enhanced)
    [[-17.3, 14.8], [-5.5, 15.5], [10.5, 13.0], [14.5, 12.5], [18.5, 4.5], [25.0, 5.0], [30.0, 10.0], [35.0, 15.0], [40.0, 20.0], [45.0, 25.0], [48.0, 30.0], [50.0, 32.0], [51.0, 30.0], [48.0, 25.0], [45.0, 20.0], [40.0, 15.0], [35.0, 10.0], [30.0, 5.0], [25.0, 0.0], [20.5, -4.5], [18.0, -18.0], [20.0, -34.8], [18.5, -34.0], [12.5, -17.0], [11.5, -4.0], [8.5, 4.5], [8.0, 12.0], [-4.5, 11.0], [-12.0, 10.0], [-17.3, 14.8]],
    
    // Europe + Middle East (connected)
    [[-9.5, 43.5], [-9.0, 38.5], [-5.5, 36.0], [0.0, 38.5], [3.0, 42.5], [7.5, 44.0], [10.0, 46.5], [16.0, 45.5], [20.0, 45.0], [29.0, 45.5], [35.0, 45.0], [40.0, 42.0], [45.0, 40.0], [50.0, 38.0], [55.0, 36.0], [60.0, 35.0], [65.0, 34.0], [70.0, 33.0], [75.0, 32.0], [80.0, 30.0], [85.0, 28.0], [75.0, 36.0], [67.0, 45.0], [50.0, 45.0], [40.0, 48.0], [30.0, 52.0], [30.0, 59.5], [24.0, 65.0], [25.5, 71.0], [15.0, 68.0], [12.0, 65.0], [5.0, 58.5], [-1.0, 50.5], [-5.5, 48.5], [-9.5, 43.5]],
    
    // Asia (enhanced with better coverage)
    ...
    // North America (enhanced with USA connection)
    [[-168.0, 65.5], [-165.0, 60.0], [-153.0, 57.0], [-130.0, 54.5], [-125.0, 48.5], [-120.0, 45.0], [-115.0, 40.0], [-110.0, 35.0], [-105.0, 30.0], [-100.0, 25.0], [-95.0, 25.0], [-90.0, 29.0], [-85.0, 35.0], [-80.0, 40.0], [-75.0, 42.0], [-70.0, 45.0], [-60.0, 47.0], [-56.0, 51.0], [-56.0, 58.5], [-62.0, 60.0], [-78.0, 62.0], [-75.0, 68.0], [-85.0, 70.0], [-95.0, 72.0], [-105.0, 73.0], [-115.0, 74.0], [-125.0, 71.0], [-135.0, 69.0], [-155.0, 71.0], [-168.0, 65.5]],
    
    // Central America + Mexico (enhanced)
    [[-125.0, 48.5], [-120.0, 45.0], [-117.0, 32.5], [-110.0, 23.5], [-105.0, 20.0], [-100.0, 18.0], [-97.0, 15.5], [-90.0, 14.0], [-85.0, 12.0], [-83.0, 8.5], [-77.0, 7.5], [-81.0, 11.0], [-87.0, 13.0], [-87.5, 17.5], [-91.0, 18.0], [-97.0, 26.0], [-110.0, 31.0], [-114.0, 32.5], [-117.0, 32.5], [-120.0, 35.0], [-125.0, 48.5]],
