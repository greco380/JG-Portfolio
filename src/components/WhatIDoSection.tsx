    ...
    <section id="skills" className="min-h-screen py-20" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="lg:hidden">
          ...
          >
            <motion.div variants={itemVariants}>
              <h3 className="text-xl font-bold mb-4 text-blue-200 leading-relaxed text-center">
                I specialize in building systems that work <span className="italic">for you</span>,
                not the other way around.
              </h3>
            </motion.div>
            
            <motion.ul className="space-y-3 text-base" variants={containerVariants}>
        ...
        <div className="hidden lg:flex gap-12">
          ...
          >
            <motion.div variants={itemVariants}>
              <h3 className="text-2xl font-bold mb-6 text-blue-200 leading-relaxed">
                I specialize in building systems that work <span className="italic">for you</span>,
                not the other way around.
              </h3>
            </motion.div>
